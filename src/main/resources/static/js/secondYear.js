...
function onConnected() {
	stompClient.subscribe('/topic/secondYear', onMessageReceived);

	stompClient.send("/app/second.addUser",
		{},
...
function sendMessage(event) {
	...
	if (messageContent && stompClient) {
		...
		stompClient.send("/app/second.sendMessage", {}, JSON.stringify(chatMessage));
		messageInput.value = '';
	}
	event.preventDefault();
}
...
function exitChat() {
	if (stompClient && stompClient.connected) {
		stompClient.unsubscribe('/topic/secondYear');
		setTimeout(() => {
