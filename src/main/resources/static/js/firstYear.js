...
function onConnected() {
	stompClient.subscribe('/topic/firstYear', onMessageReceived);

	stompClient.send("/app/first.addUser",
		{},
...
function sendMessage(event) {
	...
	if (messageContent && stompClient) {
		...
		stompClient.send("/app/first.sendMessage", {}, JSON.stringify(chatMessage));
		messageInput.value = '';
	}
	event.preventDefault();
}
...
function exitChat() {
	if (stompClient && stompClient.connected) {
		stompClient.unsubscribe('/topic/firstYear');
		setTimeout(() => {
