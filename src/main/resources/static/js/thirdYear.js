...
function onConnected() {
	stompClient.subscribe('/topic/thirdYear', onMessageReceived);

	stompClient.send("/app/third.addUser",
		{},
...
function sendMessage(event) {
	...
	if (messageContent && stompClient) {
		...
		stompClient.send("/app/third.sendMessage", {}, JSON.stringify(chatMessage));
		messageInput.value = '';
	}
	event.preventDefault();
}
...
function exitChat() {
	if (stompClient && stompClient.connected) {
		stompClient.unsubscribe('/topic/thirdYear');
		setTimeout(() => {
