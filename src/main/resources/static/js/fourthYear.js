...
function onConnected() {
	stompClient.subscribe('/topic/fourthYear', onMessageReceived);

	stompClient.send("/app/fourth.addUser",
		{},
...
function sendMessage(event) {
	...
	if (messageContent && stompClient) {
		...
		stompClient.send("/app/fourth.sendMessage", {}, JSON.stringify(chatMessage));
		messageInput.value = '';
	}
	event.preventDefault();
}
...
function exitChat() {
	if (stompClient && stompClient.connected) {
		stompClient.unsubscribe('/topic/fourthYear');
		setTimeout(() => {
